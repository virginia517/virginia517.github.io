...
fetch(apiUrl)
  ...
  .then((jsObject) => {
   ...
   document.getElementById('p2').textContent=jsObject.towns[1].events[1];
   document.getElementById('p3').textContent=jsObject.towns[1].events[2];
   document.getElementById('p4').textContent=jsObject.towns[1].events[3];
